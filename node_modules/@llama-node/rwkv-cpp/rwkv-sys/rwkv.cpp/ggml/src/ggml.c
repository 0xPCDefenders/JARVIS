...
static const quantize_fns_t quantize_fns[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_Q4_1_O] = {
        ...
        .quantize_row_q_reference = (quantize_row_q_t) quantize_row_q4_1_o_reference,
    ...
    for (int ir = ir0; ir < ir1; ++ir) {
        ...
        for (int ic = 0; ic < ne11; ++ic) {
            ...
            for (int block_index = 0; block_index < block_count; block_index++) {
                ...
                // Load 32x4-bit integers into 32x8-bit integers
                const __m256i quant_bytes = bytes_from_nibbles_32(quant_nibbles);
                ...
                case GGML_OP_MUL_MAT:
                    {
                        ...
                        if (node->src0->type == GGML_TYPE_F16 && node->src1->type == GGML_TYPE_F32) {
                            ...
                            // Adding 32 bytes for potential alignment
                            cur = (GGML_TYPE_SIZE[GGML_TYPE_F32] * node->ne[0] + 32) * n_threads;
